...
function renderTileMap() {
    ...
    zones.tileLayout.forEach((row, rowIndex) => {
        row.forEach((tileId, colIndex) => {
            ...
            if (tileInfo) {
                const texture = loader.resources[tileInfo.imageUrl].texture;
...
function renderObjects() {
    zones.objects.forEach((obj) => {
        ...
        if (objInfo) {
            const texture = loader.resources[objInfo.imageUrl].texture;
            const sprite = new Sprite(texture);
...
function renderNPCs() {
    npcs.forEach((npc) => {
        const texture = loader.resources[npc.spritesheetUrl].texture;
        if (texture) {
